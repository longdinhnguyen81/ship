            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-lg-0 mb-3">
                        <div class="about-image"><img src="/templates/ship/images/about-2.jpg" alt=""></div>
                    </div>
                    <!--About Image End-->
                    ...
                    <div class="col-lg-6 col-12 align-self-center mt-lg-0 mt-3">
                        <div class="about-content">
                            ...
                            <div class="about-heading">
                                <h4 class="sub">We are <span class="text-primary">travelGo</span></h4>
                        ...
                        <div class="timeline-content col-lg-6 col-md-9 col-12">
                            <div class="content">
                                ...
                                <div class="images row">
                                    <div class="col-sm-6 col-12"><img src="/templates/ship/images/about-1.jpg" alt=""></div>
                                    <div class="col-sm-6 col-12"><img src="/templates/ship/images/why-us.jpg" alt=""></div>
                                </div>
                    ...
                    <div class="timeline row">
                        ...
                        <div class="timeline-content col-lg-6 col-md-9 col-12">
                            <div class="content">
                                ...
                                <div class="image"><img src="/templates/ship/images/about-1.jpg" alt=""></div>
                                <h3 class="title">Duis aliquam hendrerit</h3>
                                <div class="desc">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis ipsam, pariatur numquam dolores, nobis quae ea, voluptatum rem aspernatur debitis ab! Quo, ex voluptas a!</p>
                                </div>
