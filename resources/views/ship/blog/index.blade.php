      ...
      <div class="col-lg-8 col-md-12 col-xs-12">
        <div class="row"> 
          ...
          <div class="col-lg-6 col-sm-6 mb-4">
            <div class="card shadow border-0 h-100"><a href="post.html"><img src="/templates/ship/images/b1.jpg" alt="..." class="img-fluid card-img-top"></a>
              <div class="card-body">
                ...
                <p class="my-2 text-muted text-sm">Pellentesque habitant morbi tristique senectus. Vestibulum tortor quam, feugiat vitae, ultricies ege...</p>
                <a href="post.html" class="btn btn-link pl-0">Read more<i class="fa fa-long-arrow-alt-right ml-2"></i></a> </div>
            </div>
          </div>
          
          <!-- blog item-->
          <div class="col-lg-6 col-sm-6 mb-4">
            <div class="card shadow border-0 h-100"><a href="post.html"><img src="/templates/ship/images/b3.jpg" alt="..." class="img-fluid card-img-top"></a>
              <div class="card-body">
          ...
          <!-- blog item-->
          <div class="col-lg-6 col-sm-6 mb-4">
            <div class="card shadow border-0 h-100"><a href="post.html"><img src="/templates/ship/images/b2.jpg" alt="..." class="img-fluid card-img-top"></a>
              <div class="card-body">
                <h5 class="my-2"><a href="post.html" class="text-dark">Newest photo apps </a></h5>
                <p class="text-gray-500 text-sm my-3"><i class="far fa-clock mr-2"></i>January 16, 2019</p>
                <p class="my-2 text-muted text-sm">ellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibu...</p>
                <a href="post.html" class="btn btn-link pl-0">Read more<i class="fa fa-long-arrow-alt-right ml-2"></i></a> </div>
            </div>
          </div>
          <!-- blog item-->
        ...
        <div class="blog-sidebar">
          ...
          <div class="widget category-widget">
            ...
            <ul>
              ...
              <li><a href="#">Financial Planning <span>(7)</span></a></li>
          ...
          <div class="widget recent-post-widget">
            ...
            <div class="posts">
              <div class="post">
                <div class="img-holder"> <img src="/templates/ship/images/b1.jpg" alt=""> </div>
                <div class="details">
                  <h4><a href="#">Slightly domed and divided by arches</a></h4>
                  <span class="date">Mar 19 2019</span> </div>
              </div>
              <div class="post">
                <div class="img-holder"> <img src="/templates/ship/images/b2.jpg" alt=""> </div>
                <div class="details">
                  <h4><a href="#">Collection of textile samples lay spread</a></h4>
                  <span class="date">Mar 19 2019</span> </div>
              </div>
              <div class="post">
                <div class="img-holder"> <img src="/templates/ship/images/b3.jpg" alt=""> </div>
                <div class="details">
