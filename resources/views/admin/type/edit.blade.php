                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="{{ route('admin.type.edit', ['id' => $id, 'cid' => $type->id]) }}" method="post" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="number" class="form-control" name="cost" value="{{ $type->cost }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
