                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="{{ route('admin.train.index') }}">Quản lý tin tức</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Sửa tin tức</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="{{ route('admin.detail.edit', $detail->id) }}" method="post" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Tiêu đề</label>
                                                            </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="keywords" value="{{ $detail->keywords }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <textarea style="width: 100%;border: 1px solid #ddd" rows="10" name="detail" id="editor1">{{ $detail->detail }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
