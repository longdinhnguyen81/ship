                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="{{ route('admin.car.index') }}">Quản lý xe</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Sửa xe</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <form action="{{ route('admin.car.edit', $car->id) }}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Tên xe</label>
                                                            </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="keywords" value="{{ $car->keywords }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <textarea style="width: 100%;border: 1px solid #ddd" rows="10" name="detail" id="editor1">{{ $car->detail }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
